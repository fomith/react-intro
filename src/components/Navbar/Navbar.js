    ...
    return (
        <div>
            ...
            <div className={a.friendsBlock}>
                <h3>Мои друзья</h3>
                <ul>
                    <li><NavLink to="/2" activeClassName={a.active}>Ваня</NavLink></li>
                    <li><NavLink to="/3" activeClassName={a.active}>Валя</NavLink></li>
                    <li><NavLink to="/4" activeClassName={a.active}>Зина</NavLink></li>
                </ul>
            </div>
        </div>
    )
